...
st.title("📑 Proforma Invoice Generator (v12.6.2)")
...
if agg_df is not None:
    ...
    if st.button("Generate Proforma Invoice"):
        ...
        # indent compute for payment alignment
        ...
        # ROW 1 RIGHT - top-aligned nested rows with explicit rowHeights and per-row VALIGN
        ...
        # IMPORTANT: explicit rowHeights and explicit per-row VALIGN to pin both to TOP
        right_stack = Table([[right_top],[right_bottom]], colWidths=[right_width], rowHeights=[None, None])
        right_stack.setStyle(TableStyle([
            ("VALIGN",(0,0),(0,0),"TOP"),   # top-align top row
            ("VALIGN",(0,1),(0,1),"TOP"),   # top-align bottom row
            ("LEFTPADDING",(0,0),(-1,-1),0),
            ("RIGHTPADDING",(0,0),(-1,-1),0),
            ("TOPPADDING",(0,0),(-1,-1),0),
            ("BOTTOMPADDING",(0,0),(-1,-1),0),
        ...
        # Payment block alignment values
        ...
        # FORCE top alignment for both columns across rows
