...
st.title("📑 Proforma Invoice Generator (v12.8.3)")
...
if agg_df is not None:
    ...
    if st.button("Generate Proforma Invoice"):
        ...
        # proportions & PRE-CALC column widths (robust)
        style_prop = 0.125
        item_prop = 0.185
        fabric_prop = 0.12
        ...
        origin_left_absolute = sum(col_widths[:5])  # left edge of ORIGIN (= sum widths of columns before ORIGIN)
        indent_inside_right = origin_left_absolute - left_width

        # IMPORTANT CORRECTION:
        # Account for the per-cell LEFTPADDING used in the items table (we use LEFTPADDING=4 there),
        # which visually shifts the ORIGIN cell RIGHT by that padding amount.
        # Subtract this small padding so the ': -' column hits the visual left edge of ORIGIN.
        items_cell_left_padding = 4  # this matches ("LEFTPADDING",...) used on the items table cells
        ...
        if indent_inside_right_corrected > (right_width * 0.95):
            indent_inside_right_corrected = right_width * 0.6
        ...
        supplier_title.setStyle(TableStyle([("LEFTPADDING",(0,0),(-1,-1),0),("RIGHTPADDING",(0,0),(-1,-1),0),("VALIGN",(0,0),(-1,-1),"TOP")]))
        ...
        supplier_contact.setStyle(TableStyle([("LEFTPADDING",(0,0),(-1,-1),0),("RIGHTPADDING",(0,0),(-1,-1),2),("VALIGN",(0,0),(-1,-1),"TOP")]))
        ...
        right_top.setStyle(TableStyle([("LEFTPADDING",(0,0),(-1,-1),4),("RIGHTPADDING",(0,0),(-1,-1),4),("VALIGN",(0,0),(-1,-1),"TOP"),("LINEBELOW",(0,0),(0,0),0.6,colors.black)]))
        ...
        right_bottom.setStyle(TableStyle([("LEFTPADDING",(0,0),(-1,-1),4),("RIGHTPADDING",(0,0),(-1,-1),4),("VALIGN",(0,0),(-1,-1),"TOP")]))
        ...
        # Consignee (left) - match Row1 font size
        ...
        # compute columns for bank inner grid such that ':-' LEFT aligns exactly at ORIGIN start
        colon_w = 10
        # corrected spacer to position colon left edge at ORIGIN left edge
        spacer_to_origin = max(0, indent_inside_right_corrected - colon_w)
        ...
        # add left breather identical to Row1
        ...
        left_row3_para = Paragraph(f"<b>Loading Country:</b> {made_in or ''}<br/><b>Port of Loading:</b> {loading_port or ''}<br/><b>Agreed Shipment Date:</b> {ship_date or ''}", normal)
        ...
        right_row3_para = Paragraph(f"<b>Loading Country:</b> {made_in or ''}<br/><b>L/C Advising Bank:</b> (If applicable)<br/><b>Remarks:</b> (if any)", normal)
        ...
        header_table = Table([[supplier_stack, right_stack],[consignee_box, payment_block],[left_row3_box, right_row3_box],[left_row4_box, right_row4_box]], colWidths=[left_width, right_width])
        header_table.setStyle(TableStyle([("VALIGN",(0,0),(0,3),"TOP"),("VALIGN",(1,0),(1,3),"TOP"),("LINEAFTER",(0,0),(0,3),0.75,colors.black),("LINEBELOW",(0,0),(1,0),0.35,colors.black),("LINEBELOW",(0,1),(1,1),0.35,colors.black),("LINEBELOW",(0,2),(1,2),0.35,colors.black),("LINEBELOW",(0,3),(1,3),0.5,colors.black),("LEFTPADDING",(0,0),(-1,-1),0),("RIGHTPADDING",(0,0),(-1,-1),0),("TOPPADDING",(0,0),(-1,-1),2),("BOTTOMPADDING",(0,0),(-1,-1),2),]))
        ...
        style=TableStyle([("GRID",(0,0),(-1,-1),0.25,colors.black),("BACKGROUND",(0,0),(-1,0),colors.black),("TEXTCOLOR",(0,0),(-1,0),colors.whitesmoke),("ALIGN",(0,0),(-1,0),"CENTER"),("FONTNAME",(0,0),(-1,0),"Helvetica-Bold"),("FONTSIZE",(0,0),(-1,0),7),("ALIGN",(0,1),(5,-1),"CENTER"),("ALIGN",(6,1),(-1,-1),"RIGHT"),("FONTSIZE",(0,1),(-1,-1),8),("VALIGN",(0,0),(-1,-1),"MIDDLE"),("LEFTPADDING",(0,0),(-1,-1),4),("RIGHTPADDING",(0,0),(-1,-1),4),])
        ...
        sign_table.setStyle(TableStyle([("GRID",(0,0),(-1,-1),0.25,colors.black),("VALIGN",(0,0),(-1,-1),"MIDDLE"),("ALIGN",(0,0),(0,0),"LEFT"),("ALIGN",(1,0),(1,0),"RIGHT"),("FONTSIZE",(0,0),(-1,-1),8),("LEFTPADDING",(0,0),(-1,-1),4),("RIGHTPADDING",(0,0),(-1,-1),4),]))
